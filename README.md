[![Run App Swartz, Gavin](https://github.com/Gavin-Swartz/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/Gavin-Swartz/GithubActions/actions/workflows/ci.yml)
